...
//            [v(13.5, .g), v(49.9, .g)],
//            [v(0.88, .g), v(3.0, .g)],
//            [v(215.0, .mg), v(795.0, .mg)],
//            [v(467.0, .mg), v(1730.0, .mg)],
//        ]
//    ],
//
//    "EC391CA2-6E7C-4AF0-8150-CF9B8EF1B4BC": [
//        [
//            [v(584.0, .kj), v(2160.0, .kj)],
//            [v(2.4, .g), v(8.7, .g)],
//            [v(7.2, .g), v(26.7, .g)],
//            [v(3.5, .g), v(13.0, .g)],
//            [v(15.9, .g), v(58.8, .g)],
//            [v(0.6, .g), v(2.4, .g)],
//            [v(1.0, .g), v(3.6, .g)],
//            [v(172.0, .mg), v(638.0, .mg)],
//            [v(52.0, .mg), v(194.0, .mg)],
//        ]
//    ],
//
...
/// Jam
let SingledOutTestCase: UUID? = UUID(uuidString: "2E4AD23E-AE7C-4B35-9BE2-3C9F915B892E")!

/// Cake
//let SingledOutTestCase: UUID? = UUID(uuidString: "B97C180E-6924-470F-895A-F4AD6BA0A248")!
